namespace JulySoundcheck.Migrations
{
    ...
    public partial class init1 : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Reviews", "Reviewee_Id", c => c.String(maxLength: 128));
            ...
            CreateIndex("dbo.Reviews", "Reviewee_Id");
            CreateIndex("dbo.AspNetUsers", "UserName", unique: true, name: "UserNameIndex");
            AddForeignKey("dbo.Reviews", "Reviewee_Id", "dbo.AspNetUsers", "Id");
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.Reviews", "Reviewee_Id", "dbo.AspNetUsers");
            ...
            DropColumn("dbo.Reviews", "Reviewee_Id");
